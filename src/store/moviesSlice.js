...
export const { addNowPlayingMovies, addTrailerVideo, addPopularMovies, addUpcomingMovies, addTopRatedMovies, addClassicMovies, addComedyMovies, addFantasyMovies, addHorrorMovies } = moviesSlice.actions;
